...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'COMMON$CLOUDAI',
  'COMMON$PENTEST',
  'PENTEST_CHECKLIST$SECTION_MOBILE',
  'WORKSPACE_TYPE$ASSETS_PLACEHOLDER',
  'CONVERSATION$ACP_AGENT_GENERIC',
  'CONVERSATION$BUDGET_USAGE_FORMAT',
  'CONVERSATION_PANEL$PREVIEW_GIT',
  'FILES$VSCODE',
  'GITHUB$AUTH_SCOPE',
  'GIT_PROVIDERS$HOST_PLACEHOLDER',
  'HOME$CLONE_REPO_URL_PLACEHOLDER',
  'INTEGRATIONS$APPWRITE_NAME',
  'INTEGRATIONS$DEPENDENCY_TRACK_NAME',
  'INTEGRATIONS$PLANE_NAME',
  'INTEGRATIONS$PLANE_URL_PLACEHOLDER',
  'INTEGRATIONS$BASE_URL_PLACEHOLDER',
  'INTEGRATIONS$ENDPOINT',
  'INTEGRATIONS$WORKSPACE',
  'SECURITY$FILTER_TOOL_SAST',
  'SECURITY$FILTER_TOOL_SCA',
  'SECURITY$EXPORT_CSV',
