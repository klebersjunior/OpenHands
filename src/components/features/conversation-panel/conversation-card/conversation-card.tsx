...
export function ConversationCard({
  ...
  const storedWorkspaceType = React.useSyncExternalStore(
    subscribeConversationMetadata,
    () =>
      conversationId
        ? (getStoredConversationMetadata(conversationId)?.workspace_type ?? "")
        : "",
    () => "",
  );
  const isPentestWorkspace = storedWorkspaceType === "pentest";
